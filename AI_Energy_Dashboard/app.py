...
# ============================================
# ⚙️ SECTION: Key Performance Indicators (KPIs)
# ============================================
...
# ============================================
# 📋 SECTION: AI Summary Report
# ============================================
    st.subheader("AI Summary Report")
    st.markdown(f"**Peak Load Month:** {peak_month}")
    st.markdown(f"**Average Energy Usage:** {df['Energy_kWh'].mean():.2f} kWh")
...
# ============================================
# 💸 SECTION: Potential Savings Calculation
# ============================================
    inefficient_df = df[df["Efficiency_Score"] < 90].copy()
